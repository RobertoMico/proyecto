...
import net.daw.dao.generic.specific.implementation.JugadorDaoGenSpImpl;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (ServletFileUpload.isMultipartContent(request)) {
            try {
                ...
                strMessage = "<h1>Imagen subida correctamente</h1>";
                ...
                JugadorDaoGenSpImpl oJugadorDAO = new JugadorDaoGenSpImpl("jugador", oConnection);
