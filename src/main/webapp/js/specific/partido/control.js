...
var partidoControl = function (strClase) {
    this.clase = strClase;
};
partidoControl.prototype = new control('partido');
partidoControl.prototype.getClassName = function () {
    return this.getClassName() + "Control";
};
var oPartidoControl = new partidoControl('partido');

//partidoControl.prototype.new = function (place, objParams, oModel, oView) {
//    var thisObject = this;
//    $(place).empty();
